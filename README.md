...
The website (http://oit.tudelft.nl/CT1000/) is created using the [TeachBooks](https://teachbooks.io/). To recreate it you have two options (more information in the [TeachBooks manual](https://teachbooks.io/manual/):
